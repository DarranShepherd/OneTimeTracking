...
options_controller = ($scope) ->
  ...
  storage.get option_keys, (items) ->
    ...
    $scope.preferences          = items.hayfever_prefs || { badge_display: 'total', badge_format: 'clock', badge_color: '#207aac', logBugToUserStory: false, useEpicsForTpHarvestMapping: false }
